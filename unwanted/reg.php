      ...
      <div class="row">
        ...
        <div class="row">
            <div>
              ...
              <input type="text" id="schoolDay1" name="school_teacher_1"/></div>
            ...
            <div>
              ...
              <input type="text" id="schoolDay2" name="school_teacher_2"/>
        ...
        <div class="row">
            ...
            <div>
              ...
              <label for="schoolDay2">School Teacher Mobile no. Day 2</label><br>
              <input type="text" id="schoolDay2" name="school_teacher_m2"/><br>
        </div>
        </div>
