    ...
    // Check connection
        if($db == false){
            die("ERROR: Could not connect. " . mysqli_connect_error());
                ...
                <a class="navbar-item" name ="logout" href="logout.php">
                        Logout
                </a>
...
<span><h1>Level 0</h1></span><br>
        ...
        $ans = $_POST['Answer'];
        $answer = '';
        $answerq = "SELECT * FROM encredx_data WHERE level_no='0'";
        ...
        $levup = 1;
        if($ans == $answer){
          	$lupquery = "UPDATE encredx SET user_level = 1 WHERE user_uname = '$user' ";
